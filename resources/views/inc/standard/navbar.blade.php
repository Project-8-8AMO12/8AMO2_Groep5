<nav class="navbar navbar-expand-lg navbar-light bg-light p-3">
    <div class="container">
        <a class="navbar-brand" href="/">
            <img src="images/logo.png" width="181" height="50" class="d-inline-block align-top mr-5" alt="imkersLeiden">
        </a>
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-item nav-link" href="/activiteiten">Activiteiten <span class="sr-only">(current)</span></a>
